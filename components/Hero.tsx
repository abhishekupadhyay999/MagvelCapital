...
export default function Hero() {
  return (
    <section
      id="home"
      className="pt-44 pb-24 bg-gradient-to-br from-blue-50 via-white to-yellow-50"
    >
      <div className="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <p className="mt-6 text-gray-600 text-lg max-w-xl">
            ...
            Get competitive interest rates, quick approvals and
            complete documentation support from our experts.
          </p>
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <a
              href="#contact"
              className="bg-yellow-500 hover:bg-yellow-600 text-white px-7 py-3 rounded-lg font-semibold shadow-lg transition"
            >
              Apply For Loan
            </a>
            ...
            <a
              href="#services"
              className="border-2 border-blue-900 text-blue-900 px-7 py-3 rounded-lg font-semibold hover:bg-blue-900 hover:text-white transition"
            >
              Explore Services
            </a>
          </div>
